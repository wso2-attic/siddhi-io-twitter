package org.wso2.extension.siddhi.io.twitter.sink;
...
public class TwitterSink extends Sink {
    private static final Logger log = Logger.getLogger(TwitterSink.class);
